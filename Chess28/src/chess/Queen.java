package chess;
/**
 * Queen class that portray a queen's behavior
 * 
...
public class Queen implements Piece{
	...
	/** Row index of the Queen's location */
	int row;
	
	/** Column index of the Queen's location */
	int col;
	
	/** If Queen is still alive */
	boolean isAlive = true;
	
	/**
	 * Constructor - initializes the fields
	 * 
	 * @param col Column index of the Queen
