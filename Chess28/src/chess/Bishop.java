package chess;
/**
 * Bishop class that portray a bishop's behavior
 * 
...
public class Bishop implements Piece{
	...
	/** Row index of the Bishop's location */
	int row;
	
	/** Column index of the Bishop's location */
	int col;
	
	/** If Bishop is still alive */
	boolean isAlive = true;
	
	/**
	 * Constructor - initializes the fields
	 * 
	 * @param col Column index of the Bishop
	...
	public boolean moveValid(int currCol, int currRow, int tarCol, int tarRow, char color) {
		...
		if(Math.abs(currCol - tarCol) == Math.abs(currRow - tarRow))
			return true;
